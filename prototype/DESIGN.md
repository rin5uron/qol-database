...
**リンゴラボ（仮）**は、管理栄養士りんちゃんが運営する温活・美容・栄養の情報サイト。「1日1個のりんご習慣」をコアコンセプトに、**頑張らない**温活習慣を提案する。

**キーメッセージ**:
「整う生活は、置くだけで始まる」※今後見直し検討

### 1.2 ターゲットユーザー

- **年齢**: 25〜45歳女性
- **悩み**: 冷え・むくみ・肌荒れ・忙しくて自分の時間がない
- **志向**: 丁寧な暮らしに憧れるが、完璧主義ではない
